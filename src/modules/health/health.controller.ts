import { Controller, Get, Post, Param, HttpException, HttpStatus, Logger, UseInterceptors } from '@nestjs/common';
...
import { CacheTTL, CacheKey, NoCache } from '../../common/decorators/cache.decorator';
...
export class HealthController {
  ...
  private async checkCoreService(): Promise<{ status: string; error?: string }> {
    try {
